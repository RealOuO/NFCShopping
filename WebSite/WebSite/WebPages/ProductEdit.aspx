<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.Master" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="NFCShoppingWebSite.WebPages.ProductEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="SecCategoriesDropDownList" runat="server" 
        DataSourceID="SecCategoriesDataSource" DataTextField="secCategoryName" 
        DataValueField="secCategoryID">
    </asp:DropDownList>
    <div>
    </div>
    ...
    <asp:Button ID="SubmitButton" runat="server" Height="48px" 
        onclick="SubmitButton_Click" Text="确定提交" Width="136px" />
    <asp:ObjectDataSource ID="ProductsDataSource" runat="server" 
        ...
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="id" SessionField="productID" 
                Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
    ...
    <asp:ObjectDataSource ID="CategoriesDataSource" runat="server" 
        DataObjectTypeName="NFCShoppingWebSite.Access_Data.Category" 
        DeleteMethod="DeleteCategory" InsertMethod="InsertCategory" 
        SelectMethod="GetCategories" TypeName="NFCShoppingWebSite.BLL.CategoryBL" 
    ...
    <asp:ObjectDataSource ID="SecCategoriesDataSource" runat="server" 
        DataObjectTypeName="NFCShoppingWebSite.Access_Data.SecCategory" 
        DeleteMethod="DeleteSecCategory" InsertMethod="InsertSecCategory" 
        SelectMethod="GetSecCategoriesByCategory" 
        TypeName="NFCShoppingWebSite.BLL.SecCategoryBL" 
        UpdateMethod="UpdateSecCategory">
        <SelectParameters>
            <asp:ControlParameter ControlID="CategoriesDropDownList" DefaultValue="0" 
